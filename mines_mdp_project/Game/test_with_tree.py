...
from Agents import Agent_Russel_with_tree
...
class Simulation:
	...
	def __init__(self):
		...
		self.a = Agent_Russel_with_tree.Agent(map_size/2,map_size/2,max_depth,depth,Gamma,upper_confidence_c,action_space_num,map_size,self.e.mine_data)
		self.a_imaginary = Agent_Russel_with_tree.Agent(map_size/2,map_size/2,max_depth,depth,Gamma,upper_confidence_c,action_space_num,map_size,self.e.mine_data)
		...
		for i in range(num_workers):
			self.i_a.append(Agent_Russel_with_tree.Agent(map_size/2,map_size/2,max_depth,depth,Gamma,upper_confidence_c,action_space_num,map_size,self.e.mine_data))
			self.i_a_.append(Agent_Russel_with_tree.Agent(map_size/2,map_size/2,max_depth,depth,Gamma,upper_confidence_c,action_space_num,map_size,self.e.mine_data))
