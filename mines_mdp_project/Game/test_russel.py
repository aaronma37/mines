...
class Simulation:
	...
	def __init__(self):
		...
		for i in range(num_workers):
			self.i_a.append(Agent_Russel.Agent(map_size/2,map_size/2,max_depth,depth,Gamma,upper_confidence_c,action_space_num,map_size,self.e.mine_data))
			self.i_a_.append(Agent_Russel.Agent(map_size/2,map_size/2,max_depth,depth,Gamma,upper_confidence_c,action_space_num,map_size,self.e.mine_data))
