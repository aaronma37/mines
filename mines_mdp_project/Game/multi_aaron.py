...
class Simulation:
	...
	def __init__(self):
		...
		self.a = Agent_aaron_multi.Agent(map_size/2,map_size/2,map_size,self.e.mine_data)
		self.a_imaginary = Agent_aaron_multi.Agent(map_size/2,map_size/2,map_size,self.e.mine_data)
